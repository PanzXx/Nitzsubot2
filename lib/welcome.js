...
module.exports.welcome = async(iswel, isleft, juna, anu) =>{
    ...
    var wc = await getBuffer(`https://api.zeltoria.my.id/api/maker/welcome?name=${num.split("@")[0]}&gpname=${groupName}&member=${metadata.participants.length}&pp=${pp_user}&bg=https://telegra.ph/file/2f091c68862adce3ed04f.jpg&apikey=Elistz`)
   ...
   var lf = await getBuffer(`https://telegra.ph/file/711bec4f61abc7c31a3b2.jpg`) 
await juna.sendMessage(anu.id, {image: lf, caption: `Sayonaraa @${num.split("@")[0]}`, mentions: [num]}, {quoted:fkontaku})
                        } 

...
╎𖡹 𝗟𝗶𝗺𝗶𝘁 𝗚𝗮𝗺𝗲 : ${isCreator ? 'Unlimited' : cekGLimit(sender, gcount, glimit)}
╎〄 𝗕𝗮𝗹𝗮𝗻𝗰𝗲 : ${getBalance(sender, balance)}
╠┈「 *BOT INFO* 」┈┈┈┈⏧
╎𐙦 𝗖𝗿𝗲𝗮𝘁𝗼𝗿 : ${ownerName}
╎𑜿 𝗕𝗼𝘁 𝗡𝗮𝗺𝗲 : ${botName}
╎𖠄 𝗧𝗶𝗺𝗲 : ${jam}
╎𖣐 𝗗𝗮𝘁𝗲 : ${tanggal(new Date())}
...
╎╘═════════════⨷
╚┈┈┈┈┈┈┈┈┈┈┈┈┈┈⏧
type *.newfeature* for list new feature
